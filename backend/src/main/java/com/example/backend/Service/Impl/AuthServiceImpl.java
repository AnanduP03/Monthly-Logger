...
public class AuthServiceImpl implements AuthService {
    ...
    public boolean register(UserDto userDto) throws Exception {
        try {
            ...
            if (userRepository.existsByConsumerNumber(userDto.getConsumerNumber())){
                System.out.println("Consumer Number already exists: "+userDto.getConsumerNumber());
                throw new EmailExistsException("Consumer Number already exists: "+ userDto.getConsumerNumber());
            }

            User user=new User();
            user.setUsername(userDto.getUsername());
            user.setConsumerNumber(userDto.getConsumerNumber());
    ...
    public boolean passwordValidate(String password) throws Exception {
        try {
            ...
            if (result.isValid()) {
                ...
                throw new RuntimeException("Invalid Password: "+validator.getMessages(result));
            }
        } catch (Exception e) {
